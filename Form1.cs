...
namespace Rogalik_s_3D
{
    public partial class Form : System.Windows.Forms.Form
    {
        ...
        // ----- Z-Buffer - это только начало, пока легко и просто ----- //
        ...
        // ----- Удаление невидимых граней ПРАВИЛЬНО РАСТАВЬ ВЕРШИНЫ В ТРЕУГОЛЬНИКАХ ИЛИ СМЕРТЬ, и не забудь обновлять нормали----- //
